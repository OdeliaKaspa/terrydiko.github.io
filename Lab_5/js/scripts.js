...
name.innerText = myFullName + "'s List of countries";

const getContent = document.querySelector('.content');
const setbutton = document.createElement('button');
getContent.appendChild(setbutton);
setbutton.innerText = "Get Countries";


const setList = document.createElement('ol');
setList.className = 'countries';
getContent.appendChild(setList);

const getButton = document.querySelector('button');
getButton.setAttribute("onclick", "getCountries()")
